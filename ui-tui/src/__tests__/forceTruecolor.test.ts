...
describe('forceTruecolor', () => {
  ...
  it('respects existing FORCE_COLOR unless OpenAgents truecolor is explicit', async () => {
    await withCleanEnv(
      () => {
  ...
  it('lets explicit OpenAgents truecolor override existing FORCE_COLOR', async () => {
    await withCleanEnv(
      () => {
