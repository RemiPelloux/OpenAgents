...
version: 0.1.0
author: Mibay (Mibayy), OpenAgents
license: MIT
...
```
SCRIPT=~/.openagents/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.openagents/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
