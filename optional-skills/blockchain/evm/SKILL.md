...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), OpenAgents
license: MIT
...
Helper script path: `~/.openagents/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.openagents/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.openagents/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.openagents/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
