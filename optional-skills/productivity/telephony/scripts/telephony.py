...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p = sub.add_parser(
        "save-twilio", help="Save Twilio credentials to the OpenAgents .env file"
    )
    ...
    p = sub.add_parser(
        "save-bland", help="Save Bland.ai settings to the OpenAgents .env file"
    )
    p.add_argument("api_key")
    p.add_argument("--voice", default=BLAND_DEFAULT_VOICE)

    p = sub.add_parser(
        "save-vapi", help="Save Vapi settings to the OpenAgents .env file"
    )
    p.add_argument("api_key")
