...
Data file: $OPENAGENTS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_OPENAGENTS_HOME = Path(os.environ.get("OPENAGENTS_HOME", Path.home() / ".hermes"))
DATA_DIR = _OPENAGENTS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
