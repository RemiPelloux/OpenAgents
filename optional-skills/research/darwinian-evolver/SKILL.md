...
version: 0.1.0
author: Bihruze (Asahi0x), OpenAgents
license: MIT
...
import upstream classes into OpenAgents itself.
...
Open `~/.openagents/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside OpenAgents core.
   Custom driver scripts under `~/.openagents/skills/...` are user-side and fine.
