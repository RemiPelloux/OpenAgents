#!/usr/bin/env python3
"""
SWE Runner with OpenAgents Trajectory Format
...
- Outputs trajectories in OpenAgents format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Mini-SWE Runner with OpenAgents Trajectory Format
# ============================================================================
...
class MiniSWERunner:
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to OpenAgents trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to OpenAgents trajectory format
...
def main(
    ...
    """
    Run SWE tasks with OpenAgents trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with OpenAgents Trajectory Format")
    print("=" * 60)
