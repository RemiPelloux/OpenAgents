...
#   - cli.py, openagents_cli/*      -> inline on startup (no event loop)
...
def _compute_tool_definitions(
    ...
    # window). Core OpenAgents tools (toolsets._HERMES_CORE_TOOLS) are NEVER
...
def _resolve_active_context_length() -> int:
    ...
    """
    try:
        from openagents_cli.config import load_config as _load
...
def _emit_post_tool_call_hook(
    *,
    ...
    """
    try:
        from openagents_cli.plugins import has_hook, invoke_hook
