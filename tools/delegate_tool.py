...
# Must match openagents_cli.runtime_provider.RUNTIME_PROVIDER_TYPE_CUSTOM.
...
def _dump_subagent_timeout_diagnostic(
    *,
    ...
    writes a dedicated log under ``~/.openagents/logs/subagent-<sid>-<ts>.log``
