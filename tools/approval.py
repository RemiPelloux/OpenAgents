...
DANGEROUS_PATTERNS = [
    ...
    (
        ...
        "start gateway outside systemd (use 'systemctl --user restart openagents-gateway')",
    ),
    (
    ...
    (
        ...
        "in-place edit of OpenAgents config/env",
    ),
    (
        rf"\bsed\s+--in-place\b.*(?:{_HERMES_CONFIG_PATH}|{_HERMES_ENV_PATH})",
        "in-place edit of OpenAgents config/env (long flag)",
    ),
    ...
    (
        ...
        "in-place edit of OpenAgents config/env (perl/ruby)",
    ),
