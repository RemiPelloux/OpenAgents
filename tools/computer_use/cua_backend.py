...
def _cua_telemetry_disabled() -> bool:
    """True when OpenAgents should disable cua-driver telemetry for this user.
...
def _resolve_mcp_invocation(
    ...
    *,
    ...
    Surface 8 of NousResearch/openagents#47072: instead of hardcoding
...
def _parse_elements_from_structured(
    ...
    """Surface 2 of NousResearch/openagents#47072: read the canonical
...
class _CuaDriverSession:
    ...
    def __init__(self, bridge: _AsyncBridge) -> None:
        ...
        self._started = False
        # Surface 4 of NousResearch/openagents#47072: per-tool
...
def _extract_tool_result(mcp_result: Any) -> Dict[str, Any]:
    ...
    NousResearch/openagents#47072). Each entry corresponds index-for-index
...
class CuaDriverBackend(ComputerUseBackend):
    ...
    def __init__(self) -> None:
        ...
        # Surface 6 of NousResearch/openagents#47072: per-snapshot
        ...
        #   - Gets a distinct agent-cursor color per OpenAgents run, with
        ...
        #     concurrent OpenAgents runs / subagents don't step on each
        #     other.
        # We mint a UUID4-based id once per CuaDriverBackend instance —
        # one OpenAgents run = one backend = one session — and pass it as
    ...
    def capture(self, mode: str = "som", app: Optional[str] = None) -> CaptureResult:
        ...
        # Surface 3 of NousResearch/openagents#47072: read the canonical
        ...
        if mode == "vision":
            ...
            # Surface 2 of NousResearch/openagents#47072: prefer the
    ...
    def click(
        ...
        *,
        ...
        # NousResearch/openagents#47072). cua-driver-rs gained an explicit
