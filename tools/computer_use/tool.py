...
# regardless of approval level (e.g. logout kills the session OpenAgents runs in).
_BLOCKED_KEY_COMBOS = {
...
def _capture_response(
    ...
    if cap.png_b64 and cap.mode != "ax" and not image_too_small:
        ...
        # parts (Surface 7 of NousResearch/openagents#47072 — trycua/cua#1961
...
def _route_capture_through_aux_vision(
    ...
    The captured base64 PNG is materialised to ``$OPENAGENTS_HOME/cache/vision/``
    ...
    try:
        ...
        if _mime_for_ext == "image/jpeg" or (
            ...
            ext = ".png"
        cache_dir = get_openagents_dir("cache/vision", "temp_vision_images")
