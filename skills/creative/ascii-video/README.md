...
Built for [OpenAgents](https://github.com/NousResearch/openagents). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/openagents/skills/creative/ascii-video`](https://github.com/NousResearch/openagents/tree/main/skills/creative/ascii-video) via PR.
