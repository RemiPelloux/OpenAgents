#!/usr/bin/env python3
"""Google Workspace API CLI for OpenAgents.
...
from _hermes_home import get_openagents_home
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for OpenAgents")
