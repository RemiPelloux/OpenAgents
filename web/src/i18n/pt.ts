...
export const pt: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins OpenAgents (paridade com `hermes plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.openagents/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.openagents/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.openagents/skills/",
  ...
  config: {
    configPath: "~/.openagents/config.yaml",
    filters: "Filtros",
    sections: "Secções",
  ...
  env: {
    ...
    customHint: "Variáveis de ambiente arbitrárias armazenadas no seu .env que o OpenAgents não reconhece. Use-as para injetar variáveis de ambiente para skills, servidores MCP ou suas próprias ferramentas.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Distintivos colecionáveis do OpenAgents obtidos a partir do histórico real de sessões. Conquistas conhecidas mas ainda não obtidas aparecem como Descobertas; conquistas Secretas permanecem ocultas até surgir o primeiro comportamento correspondente.",
      scan_subtitle:
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o OpenAgents detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
      scan_status_header: "Estado da análise",
      scan_status_body:
        "O OpenAgents analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in OpenAgents ☤",
    },
  },
  kanban: {
