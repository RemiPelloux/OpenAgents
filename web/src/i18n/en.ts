...
export const en: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update OpenAgents plugins (`hermes plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.openagents/plugins/?",
    removeHint: "Only user-installed plugins under ~/.openagents/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.openagents/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that OpenAgents doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible OpenAgents badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning OpenAgents session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run OpenAgents more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once OpenAgents sees a related signal, the card becomes Discovered and shows its requirement.",
