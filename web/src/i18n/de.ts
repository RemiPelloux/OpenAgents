...
export const de: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Dieses Plugin aus ~/.openagents/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.openagents/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.openagents/skills/ geladen",
  ...
  env: {
    ...
    customHint: "Beliebige Umgebungsvariablen in deiner .env, die OpenAgents nicht erkennt. Verwende sie, um Umgebungsvariablen für Skills, MCP-Server oder eigene Tools einzuschleusen.",
  ...
  achievements: {
    ...
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze OpenAgents mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald OpenAgents ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
