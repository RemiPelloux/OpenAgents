...
export const es: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de OpenAgents (equivalente a `hermes plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.openagents/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.openagents/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.openagents/skills/",
  ...
  env: {
    ...
    customHint: "Variables de entorno arbitrarias almacenadas en tu .env que OpenAgents no reconoce. Úsalas para inyectar variables de entorno para skills, servidores MCP o tus propias herramientas.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Insignias coleccionables de OpenAgents ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",
      scan_subtitle:
    ...
    stats: {
      ...
      latest: "Más reciente",
      latest_hint_empty: "usa OpenAgents más",
    ...
    guide: {
      ...
      secret_body:
        "Los secretos ocultan su disparador exacto. Una vez que OpenAgents detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",
