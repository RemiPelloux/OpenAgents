 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `openagents_cli/web_server.py`.
 */
...
/**
 * Nous Blue — the inverted "light mode" OpenAgents look, ported from the
 ...
 * nousnet-web's <body> is white; openagents's App root is `bg-black`,
