...
// even though a fresh shell — and the OpenAgents CLI — sees it immediately. The
// desktop's OPENAGENTS_HOME resolution relies on process.env, so that stale-snapshot
...
//       OPENAGENTS_HOME    REG_SZ    F:\Hermes\data
//
