...
/** Why a known OpenAgents command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active OpenAgents profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show OpenAgents version', surface: exec() },
