...
export interface OAuthProvider {
   ...
   *  embedded terminal. Null when OpenAgents doesn't know how to remove it. */
...
export interface EnvVarInfo {
  ...
  // in openagents_cli/provider_catalog.py). When present, the Keys tab groups by
...
// folders. Mirrors openagents_cli/projects_db.Project.to_dict().
