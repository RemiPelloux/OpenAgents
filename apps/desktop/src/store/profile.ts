...
// /api/profiles/active `current`). "default" is the root ~/.openagents. This is the
...
// Persist the choice and relaunch the backend under the new OPENAGENTS_HOME. The
...
// Switch to the default (root ~/.openagents) profile — bound to ⌘1.
