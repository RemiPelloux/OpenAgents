...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      loadingSettings: 'Loading OpenAgents settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting OpenAgents Desktop…'
    },
    errors: {
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your OpenAgents backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting OpenAgents Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to OpenAgents defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while OpenAgents is in the background.',
      kinds: {
        approval: {
        ...
        turnDone: {
          ...
          description: 'A turn finished while OpenAgents was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    searchPlaceholder: {
      about: 'About OpenAgents Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let OpenAgents follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what OpenAgents is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
    ...
    config: {
      ...
      loading: 'Loading OpenAgents configuration...',
    ...
    gateway: {
      ...
      intro:
        'Hermes Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running OpenAgents backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private OpenAgents backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote OpenAgents backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · OpenAgents ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. OpenAgents runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart OpenAgents to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update OpenAgents to generate pets.',
      backgroundHint: 'You can close this — OpenAgents will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure OpenAgents desktop' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent OpenAgents environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. OpenAgents will run it and deliver results to the destination you pick.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask OpenAgents to open PR',
      agentShipPrompt:
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of OpenAgents can’t update itself from inside the app.',
    ...
    manualBody: 'You installed OpenAgents from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Hermes will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the OpenAgents desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The OpenAgents updater takes over in its own window and reopens OpenAgents automatically when it’s done. Please don’t reopen OpenAgents yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. OpenAgents reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then OpenAgents reopens on its own.',
  ...
  install: {
    ...
    settingUpTitle: 'Setting up OpenAgents',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another OpenAgents CLI or desktop instance is running. Stop any running OpenAgents instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The OpenAgents installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with OpenAgents",
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point OpenAgents at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — OpenAgents connects automatically',
      loopback: 'Opens your browser to sign in — OpenAgents connects automatically',
    ...
    authorizeThere: 'Authorize OpenAgents there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize OpenAgents there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. OpenAgents will only show the first 512 KB.`,
    ...
    web: {
      ...
      askRestart: 'Ask OpenAgents to restart the server',
  ...
  assistant: {
    ...
    approval: {
      gatewayDisconnected: 'OpenAgents gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.openagents/config.yaml). OpenAgents won’t ask again for commands like this — in this session or any future one.`,
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart OpenAgents Desktop to use Save Image.',
    restartToSaveImages: 'Restart OpenAgents Desktop to save images',
