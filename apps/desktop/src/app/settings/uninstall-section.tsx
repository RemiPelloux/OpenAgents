...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The OpenAgents, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and the OpenAgents, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the Chat GUI and the OpenAgents (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — the Chat GUI, the OpenAgents, and all of your config, chats, secrets, and logs',
