...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def _has_telegram_desktop_details_math_crash_shape(self, content: str) -> bool:
        ...
        OpenAgents must skip rich delivery up front and use the legacy MarkdownV2
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "To recover: ensure no other OpenAgents or OpenClaw instance is running "
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            # readable by the OpenAgents process (shared mount, same machine, etc.).
            ...
            try:
                ...
                from openagents_cli.commands import telegram_menu_commands, telegram_menu_max_commands
                # Telegram allows up to 100 commands but has an undocumented
                # payload size limit (~4KB total).  OpenAgents defaults to 60 to
    ...
    def _build_provider_keyboard(self, providers: list):
        ...
        """
        try:
            from openagents_cli.models import group_providers
        except Exception:
    ...
    async def _handle_model_picker_callback(
        ...
        if data.startswith("mp:"):
            ...
            group_id = data[4:]
            try:
                from openagents_cli.models import PROVIDER_GROUPS
    ...
    # Scripts live in ~/.openagents/scripts/gmail-triage/. `arg` from the callback
    ...
    def _explicit_bot_mentions_exclude_self(self, message: Message) -> bool:
        ...
        Telegram groups can contain several OpenAgents bot profiles. A message like
    ...
    def _is_own_message(self, message: Message) -> bool:
        ...
        counted as incoming unread messages in the OpenAgents inbox.
        """
        if not self._bot:
            return False
    ...
    def _should_process_message(self, message: Message, *, is_command: bool = False) -> bool:
        ...
        # unread in the OpenAgents inbox (#52363).
        if self._is_own_message(message):
            return False
...
# openagents_cli/{setup,gateway}.py, and the _send_telegram dispatch in
...
def interactive_setup() -> None:
    ...
    _PLATFORMS["telegram"] static dict dispatch in openagents_cli/gateway.py.
    """
    from openagents_cli import setup as _setup_mod
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install 'openagents[telegram]'",
