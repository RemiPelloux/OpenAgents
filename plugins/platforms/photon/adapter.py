"""
Photon Spectrum (iMessage) platform adapter for OpenAgents.
...
if TYPE_CHECKING:
    ...
    try:
        import httpx
        HTTPX_AVAILABLE = True
    except ImportError:  # pragma: no cover - httpx is already a OpenAgents dep
...
class PhotonAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> "list[re.Pattern]":
        ...
        list, or comma/newline-separated), or None (use OpenAgents defaults).
    ...
    def _pid_is_sidecar(pid: int) -> bool:
        ...
        try:
            ...
            return False
        # Checkout-agnostic: any OpenAgents checkout's sidecar entry point.
...
def register(ctx) -> None:
    """Called by the OpenAgents plugin loader at startup."""
