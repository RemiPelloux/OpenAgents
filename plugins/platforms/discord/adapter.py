...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(
            name="reload-skills",
            description="Re-scan ~/.openagents/skills/ for new or removed skills",
        )
        ...
        @tree.command(
            name="update", description="Update OpenAgents to the latest version"
        )
        async def slash_update(interaction: discord.Interaction):
            await self._run_simple_slash(interaction, "/update", "Update initiated~")

        @tree.command(
            name="restart", description="Gracefully restart the OpenAgents gateway"
        )
        ...
        @tree.command(
            name="thread",
            description="Create a new thread and start a OpenAgents session in it",
        )
        @discord.app_commands.describe(
            name="Thread name",
