...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> OpenAgents gateway adapter.

    Each inbound phone number gets its own OpenAgents session (multi-tenant).
...
# static dict in openagents_cli/gateway.py, and the _send_sms dispatch in
