...
Config: ~/.openagents/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.openagents/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_openagents_home()`` helper (OPENAGENTS_HOME-aware and
...
RULES_FILE = get_openagents_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_openagents_home() / "feishu_comment_pairing.json"
