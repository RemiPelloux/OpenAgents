...
required — uses aiohttp which is already a OpenAgents dependency.
...
def interactive_setup() -> None:
    ...
    ``openagents_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where OpenAgents delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # openagents_cli/setup.py::_setup_mattermost function.
