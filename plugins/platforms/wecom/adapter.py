...
# wizard + _PLATFORMS["wecom"] static dict in openagents_cli/gateway.py, and the
...
def interactive_setup() -> None:
    ...
    Replaces openagents_cli/gateway.py::_setup_wecom and the static
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install 'openagents[wecom]'",
