...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def post_setup(self, hermes_home: str, config: dict) -> None:
        ...
        from openagents_cli.memory_setup import (
            _CANCELLED,
            _curses_select,
    ...
    def get_config_schema(self):
        return [
            ...
            },
            {
                ...
                "default": "conversation between OpenAgents and the User",
            },
            {
        ...
        if self._client is None:
            if self._mode == "local_embedded":
                ...
                logger.debug(
                    ...
                    self._config.get("profile", "openagents"),
                    llm_provider,
                )
                kwargs = dict(
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        static_bank_id = self._config.get("bank_id") or banks.get(
            "bankId", "openagents"
        )
        ...
        self._retain_context = self._config.get(
            "retain_context", "conversation between OpenAgents and the User"
        )
