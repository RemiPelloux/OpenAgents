...
session-scoped state file under ``$OPENAGENTS_HOME/workspace/meetings/.active.json``
...
# File + directory layout (under $OPENAGENTS_HOME):
#
#   workspace/meetings/
...
def _root() -> Path:
    return Path(get_openagents_home()) / "workspace" / "meetings"
