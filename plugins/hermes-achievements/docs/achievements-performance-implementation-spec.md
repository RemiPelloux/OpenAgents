# OpenAgents Achievements Implementation Spec (Detailed)
...
Storage path:
- `~/.openagents/plugins/hermes-achievements/scan_snapshot.json`
...
Checkpoint file (new):
- `~/.openagents/plugins/hermes-achievements/scan_checkpoint.json`
...
- persisted runtime files:
  - `~/.openagents/plugins/hermes-achievements/state.json` (existing unlock state)
  - `~/.openagents/plugins/hermes-achievements/scan_snapshot.json` (new)
  - `~/.openagents/plugins/hermes-achievements/scan_checkpoint.json` (new)
