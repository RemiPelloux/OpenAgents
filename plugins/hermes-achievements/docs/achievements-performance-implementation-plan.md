# OpenAgents Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.openagents/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.openagents/plugins/hermes-achievements/scan_checkpoint.json`.
