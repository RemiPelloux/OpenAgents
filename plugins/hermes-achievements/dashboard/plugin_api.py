...
ACHIEVEMENTS: List[Dict[str, Any]] = [
    # Agent Autonomy — mostly best-session feats
    {
        "id": "let_him_cook",
        "name": "Let Him Cook",
        "description": "Let OpenAgents run a serious autonomous tool chain in one session.",
    ...
    },
    {
        ...
        "description": "Accumulate a lifetime avalanche of OpenAgents tool calls across sessions.",
        "category": "Agent Autonomy",
        "kind": "lifetime",
        "icon": "avalanche",
    ...
    },
    {
        ...
        "description": "Use a wide spread of distinct OpenAgents tools in one session.",
        "category": "Agent Autonomy",
        "kind": "best_session",
        "icon": "nodes",
    ...
    # OpenAgents Native
    {
        "id": "skillsmith",
        "name": "Skillsmith",
        "description": "Work with OpenAgents skills enough to leave fingerprints.",
    ...
    },
    {
        ...
        "description": "Live through gateway-connected OpenAgents workflows.",
        "category": "Hermes Native",
        "kind": "lifetime",
        "icon": "antenna",
    ...
    },
    {
        ...
        "description": "Use a real spread of distinct model names across OpenAgents history.",
        "category": "Model Lore",
        "kind": "lifetime",
        "icon": "prism",
    ...
    },
    {
        ...
        "description": "Use models from multiple providers across OpenAgents history.",
        "category": "Model Lore",
        "kind": "lifetime",
        "icon": "swap",
    ...
    },
    {
        ...
        "description": "Actually chat with local/open-weight models through OpenAgents session metadata.",
        "category": "Model Lore",
        "kind": "lifetime",
        "icon": "terminal",
    ...
    # Workflow Intelligence
    {
        ...
        "description": "Navigate OpenAgents toolsets deliberately instead of treating tools as a blur.",
        "category": "Hermes Native",
        "kind": "lifetime",
        "icon": "compass",
    ...
    # Lifestyle
    {
        ...
        "description": "Accumulate a serious number of OpenAgents sessions.",
        "category": "Lifestyle",
        "kind": "lifetime",
        "icon": "marathon",
    ...
    },
    {
        ...
        "description": "Run OpenAgents on weekends enough times to make it a lifestyle.",
        "category": "Lifestyle",
        "kind": "lifetime",
        "icon": "calendar",
...
def snapshot_path() -> Path:
    return (
        get_openagents_home() / "plugins" / "hermes-achievements" / "scan_snapshot.json"
    )
...
def criteria_for(definition: Dict[str, Any]) -> str:
    ...
    if "threshold_metric" in definition:
        ...
        if not tiers_list:
            return (
                secret_prefix + "Requirement: use OpenAgents in the matching workflow."
            )
...
def display_achievement(item: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if clean.get("state") == "secret":
        return {
            **clean,
            "name": "???",
            "description": "Secret achievement: hidden until OpenAgents detects the first relevant behavior in your session history.",
