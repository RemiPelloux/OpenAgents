...
| 版本 | `0.1.0` |
| 作者 | Hugo Sequier (Hugo-SEQUIER), OpenAgents |
| 许可证 | MIT |
...
辅助脚本：`~/.openagents/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
对于 `state`、`spot-balances`、`fills`、`orders` 和 `review`，当 `~/.openagents/.env` 中设置了 `HYPERLIQUID_USER_ADDRESS` 时，地址参数为可选。
