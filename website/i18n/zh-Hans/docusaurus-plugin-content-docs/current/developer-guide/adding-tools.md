...
sidebar_position: 2
title: "添加工具"
description: "如何向 OpenAgents 添加新工具——schema、handler、注册与 toolset"
---
...
如果你想要个人专用、项目本地或其他自定义工具，而不修改 OpenAgents 核心，请使用插件方式：

- [插件](/user-guide/features/plugins)
- [构建 OpenAgents 插件](/guides/build-a-hermes-plugin)
...
如果你的工具需要 API 密钥，将其添加到 `openagents_cli/config.py`：
...
- [ ] 可选：已将 API 密钥添加到 `openagents_cli/config.py` 的 `OPTIONAL_ENV_VARS`
