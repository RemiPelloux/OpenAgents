...
Set your Tenor API key in your environment (add to `${OPENAGENTS_HOME:-~/.openagents}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/openagents/blob/main/skills/media/gif-search/url)`
