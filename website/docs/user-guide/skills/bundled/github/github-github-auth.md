...
- Give it a name like "openagents"
- Select scopes:
...
- Give it a title like "openagents-&lt;machine-name>"
...
elif _hermes_env="${OPENAGENTS_HOME:-$HOME/.hermes}/.env"; [ -f "$_hermes_env" ] && grep -q "^GITHUB_TOKEN=" "$_hermes_env"; then
