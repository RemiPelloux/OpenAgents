...
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), OpenAgents |
| License | MIT |
...
The script reads `${OPENAGENTS_HOME:-~/.openagents}/.env` for two optional defaults:
...
Helper script: `~/.openagents/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.openagents/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${OPENAGENTS_HOME:-~/.openagents}/.env`.
...
```bash
python3 ~/.openagents/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.openagents/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
