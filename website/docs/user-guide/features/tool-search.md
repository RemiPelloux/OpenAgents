...
:::info Built-in OpenAgents tools never defer
...
When the model invokes `tool_call`, OpenAgents **unwraps the bridge** and
...
- **No JS sandbox.** OpenAgents uses the simpler "structured tools" mode
