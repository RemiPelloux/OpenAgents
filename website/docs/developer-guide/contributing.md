...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to OpenAgents — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to OpenAgents! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying OpenAgents core? Start with [Build a OpenAgents Plugin](../guides/build-a-hermes-plugin.md)
- Building a new built-in core tool for OpenAgents itself? Start with [Adding Tools](./adding-tools.md)
...
- **Profile-safe paths**: Never hardcode `~/.openagents` — use `get_openagents_home()` from `openagents_constants` for code paths and `display_openagents_home()` for user-facing messages. See [AGENTS.md](https://github.com/NousResearch/openagents/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/NousResearch/openagents/blob/main/LICENSE).
