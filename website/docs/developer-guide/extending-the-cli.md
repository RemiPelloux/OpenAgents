...
description: "Build wrapper CLIs that extend the OpenAgents TUI with custom widgets, keybindings, and layout changes"
---
...
Called after OpenAgents registers its own keybindings and before the layout is built. Add your keybindings to `kb`.
