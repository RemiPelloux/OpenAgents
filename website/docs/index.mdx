...
slug: /
sidebar_position: 0
title: "OpenAgents Documentation"
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend OpenAgents safely  |
...
| 🗣️ **[Use Voice Mode with Hermes](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for OpenAgents voice workflows          |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of OpenAgents                              |
