...
description: "A practical guide to setting up and using OpenAgents voice mode across CLI, Telegram, Discord, and Discord voice channels"
---
...
- you want OpenAgents sitting in a Discord voice channel for live conversation
...
## Step 1: make sure normal OpenAgents works first
...
OpenAgents supports both local and cloud speech stacks.
...
4. OpenAgents transcribes and responds
...
- asking OpenAgents to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full OpenAgents loop.

## Tuning CLI behavior

### Silence threshold

If OpenAgents starts/stops too aggressively, tune:
...
OpenAgents stays a normal chat bot, but can speak replies.
...
- you want OpenAgents to function like a portable research or ops assistant
...
OpenAgents joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- OpenAgents detects speech boundaries
- transcripts are posted in the associated text channel
- OpenAgents responds in text and audio
...
1. get text OpenAgents working
2. install `openagents[voice]`
