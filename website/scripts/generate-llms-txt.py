#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the OpenAgents docs site.
...
Both publish at:
  https://openagents.nousresearch.com/docs/llms.txt
  https://openagents.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://openagents.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    (
        ...
        [
            ...
            ("guides/python-library", "Use OpenAgents as a Python Library", None),
            ...
            ("guides/build-a-hermes-plugin", "Build a OpenAgents Plugin", None),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "openagents/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/openagents")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# OpenAgents — Full Documentation\n",
        (
            "This file is the entire OpenAgents documentation concatenated for LLM "
        ...
        "Canonical site: https://openagents.nousresearch.com/docs\n",
        "Short index: https://openagents.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
