...
# 5. Symlinks the 'openagents' CLI command into a user-facing bin dir
...
echo ""
echo -e "${CYAN}⚕ OpenAgents Setup${NC}"
echo ""
...
# ============================================================================
# Seed bundled skills into ~/.openagents/skills/
# ============================================================================

HERMES_SKILLS_DIR="${OPENAGENTS_HOME:-$HOME/.hermes}/skills"
mkdir -p "$HERMES_SKILLS_DIR"

echo ""
echo "Syncing bundled skills to ~/.openagents/skills/ ..."
...
if [[ $REPLY =~ ^[Yy]$ ]] || [[ -z $REPLY ]]; then
    ...
    "$SCRIPT_DIR/venv/bin/python" -m openagents_cli.main setup
fi
