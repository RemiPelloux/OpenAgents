...
def check_systemd_timing_alignment(drain_timeout: float) -> Optional[Dict[str, Any]]:
    ...
    upgraded openagents but never re-ran ``hermes setup`` to regenerate
    ...
    try:
        # /proc/self/cgroup gives us "0::/user.slice/.../openagents-gateway.service"
    ...
    # constant in openagents_cli/gateway.py.
    headroom = 30.0
