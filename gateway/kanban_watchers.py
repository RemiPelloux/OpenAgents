...
class GatewayKanbanWatchersMixin:
    ...
    async def _kanban_dispatcher_watcher(self) -> None:
        ...
        def _ready_nonempty() -> bool:
            ...
            task on ANY board whose assignee maps to a real OpenAgents profile
            ...
            PATH, missing venv, credential loss for a real OpenAgents profile).
            """
            try:
                boards = _kb.list_boards(include_archived=False)
            except Exception:
        ...
        def _auto_decompose_tick(auto_decompose_per_tick: int) -> int:
            ...
            """
            try:
                from openagents_cli import kanban_decompose as _decomp
