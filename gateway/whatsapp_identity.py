...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$OPENAGENTS_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_openagents_dir("platforms/whatsapp/session", "whatsapp/session")
...
def canonical_whatsapp_identifier(identifier: str) -> str:
    ...
    same session-key identity OpenAgents itself uses.
