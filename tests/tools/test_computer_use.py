...
class TestClickButtonPassthrough:
    """Surface 5 (NousResearch/openagents#47072) — `middle_click` must
...
class TestImageMimeTypePropagation:
    """Surface 7 (NousResearch/openagents#47072): trycua/cua#1961 made
...
class TestMcpInvocationResolution:
    """Surface 8 (NousResearch/openagents#47072): instead of hardcoding
    ...
    the MCP subcommand doesn't require a OpenAgents patch.
    ...
    def test_future_renamed_subcommand_is_honored(self):
        ...
        instead of `mcp` keeps working without a OpenAgents patch."""
        from unittest.mock import patch
        from tools.computer_use.cua_backend import _resolve_mcp_invocation
...
class TestStructuredElementsConsumption:
    """Surface 2 (NousResearch/openagents#47072): trycua/cua#1961 made
...
class TestCapabilityDiscovery:
    """Surface 4 (NousResearch/openagents#47072): the wrapper learns
...
class TestElementTokenAttachment:
    """Surface 6 (NousResearch/openagents#47072): trycua/cua#1961 added
...
class TestSessionLifecycle:
    """Surface gap (audit June 2026): OpenAgents never declared a cua-driver
    ...
    def test_session_id_unique_per_backend(self):
        ...
        assert a != b, "each OpenAgents run should mint its own session id"
