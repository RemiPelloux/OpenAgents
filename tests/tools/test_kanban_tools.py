...
def worker_env(monkeypatch, tmp_path):
    """Simulate being a worker: OPENAGENTS_HOME isolated, HERMES_KANBAN_TASK set
...
def test_complete_metadata_round_trips_through_show(worker_env):
    ...
    handoff = {
        "changed_files": ["openagents_cli/kanban.py"],
...
def multi_board_env(monkeypatch, tmp_path):
    """Isolated OpenAgents home with two distinct kanban boards seeded.
