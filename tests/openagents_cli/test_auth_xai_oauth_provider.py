...
def test_resolve_credentials_quarantines_dead_tokens_on_terminal_refresh_failure(
    ...
    monkeypatch.setattr(
        "openagents_cli.auth._refresh_xai_oauth_tokens", _terminal_refresh
    )
...
def test_resolve_credentials_does_not_quarantine_on_transient_refresh_failure(
    ...
    monkeypatch.setattr(
        "openagents_cli.auth._refresh_xai_oauth_tokens", _transient_refresh
    )
...
def test_pool_refresh_marks_entry_exhausted_on_failure(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "openagents_cli.auth.refresh_xai_oauth_pure", _fake_refresh_fail
    )
