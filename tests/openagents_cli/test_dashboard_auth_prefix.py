...
class TestPublicUrlOverride:
    ...
    def patch_config(self, monkeypatch):
        """Replace ``openagents_cli.config.load_config`` with a stub
        ...
        def _set(public_url) -> None:
            ...
            monkeypatch.setattr("openagents_cli.config.load_config", lambda: cfg)
    ...
    def test_scheme_less_public_url_env_warns_operator(
        ...
        from openagents_cli.dashboard_auth import prefix as prefix_mod
...
class TestCookiePathRespectsPrefix:
    ...
    def test_loopback_cookies_unprefixed(self):
        ...
        from openagents_cli.dashboard_auth.cookies import set_pkce_cookie
