...
def isolated_kanban_home(monkeypatch):
    ...
    # Force-reimport so the fresh OPENAGENTS_HOME is picked up.
    ...
    # gives each test its own monkeypatched OPENAGENTS_HOME so no cross-test
    # contamination.
...
def test_dispatch_result_has_auto_assigned_default_field():
    ...
    from openagents_cli.kanban_db import DispatchResult
    r = DispatchResult()
