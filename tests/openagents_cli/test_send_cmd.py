...
``openagents_cli.send_cmd``. The underlying ``send_message_tool`` is stubbed so
...
from openagents_cli import send_cmd
...
def test_load_hermes_env_bridges_config_yaml_scalars(tmp_path, monkeypatch):
    ...
    # Force get_openagents_home() to re-resolve under the patched env.
    from importlib import reload

    import openagents_cli.config as _hc_config
