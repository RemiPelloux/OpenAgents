...
class TestCmdSetupNonTtyGuard:
    ...
    def test_missing_all_flags_returns_1(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            "openagents_cli.secrets_cli.bw.find_bws",
    ...
    def test_missing_server_url_with_env_var_passes(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "openagents_cli.secrets_cli.save_env_value", lambda *a: None
        )
        monkeypatch.setattr(
            "openagents_cli.secrets_cli.get_env_path", lambda: "/tmp/.env"
        )
        monkeypatch.setattr(
    ...
    def test_tty_does_not_trigger_guard(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "openagents_cli.secrets_cli.masked_secret_prompt",
