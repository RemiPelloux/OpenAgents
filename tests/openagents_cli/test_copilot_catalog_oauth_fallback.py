...
is set in ``~/.openagents/.env`` — the picker was silently dropping back to
...
from openagents_cli.models import _resolve_copilot_catalog_api_key
...
class TestCopilotCatalogApiKeyResolution:
    def test_env_var_token_wins_over_pool(self):
        ...
        with patch(
            ...
            "openagents_cli.auth.read_credential_pool",
        ) as mock_pool:
