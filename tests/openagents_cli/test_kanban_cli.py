"""Tests for the kanban CLI surface (openagents_cli.kanban)."""
...
from openagents_cli import kanban as kc
...
def test_board_override_is_isolated_per_concurrent_call(kanban_home, monkeypatch):
    ...
    parser = argparse.ArgumentParser(prog="openagents", add_help=False)
...
def test_kanban_in_autocomplete_table():
    from openagents_cli.commands import COMMANDS, SUBCOMMANDS
...
def test_kanban_not_gateway_only():
    ...
    from openagents_cli.commands import COMMAND_REGISTRY
