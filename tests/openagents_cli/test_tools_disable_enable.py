...
class TestToolsDisableBuiltin:
    def test_disable_removes_toolset_from_platform(self):
        ...
        with (
            patch("openagents_cli.tools_config.load_config", return_value=config),
            patch("openagents_cli.tools_config.save_config") as mock_save,
        ):
...
class TestToolsDisableMcp:
    ...
    def test_disable_unknown_server_prints_error(self, capsys):
        ...
        with (
            patch("openagents_cli.tools_config.load_config", return_value=config),
            patch("openagents_cli.tools_config.save_config"),
        ):
            tools_disable_enable_command(
                Namespace(
...
class TestToolsList:
    def test_list_shows_enabled_toolsets(self, capsys):
        ...
        with patch("openagents_cli.tools_config.load_config", return_value=config):
