"""Tests for openagents_cli.skin_engine — the data-driven skin/theme system."""
...
class TestCliBrandingHelpers:
    ...
    def test_active_prompt_symbol_ares(self):
        from openagents_cli.skin_engine import set_active_skin, get_active_prompt_symbol

        set_active_skin("ares")
        assert get_active_prompt_symbol() == "⚔ "

    def test_active_help_header_ares(self):
        from openagents_cli.skin_engine import set_active_skin, get_active_help_header

        set_active_skin("ares")
        assert get_active_help_header() == "(⚔) Available Commands"

    def test_active_goodbye_ares(self):
        from openagents_cli.skin_engine import set_active_skin, get_active_goodbye
