...
def isolated_home(tmp_path, monkeypatch):
    home = tmp_path / "home"
    openagents = home / ".hermes"
    hermes.mkdir(parents=True)
    monkeypatch.setattr(Path, "home", lambda: home)
    monkeypatch.setenv("OPENAGENTS_HOME", str(hermes))
...
def test_aborted_setup_does_not_enable_whatsapp(isolated_home, monkeypatch):
    ...
    """
    from openagents_cli.main import cmd_whatsapp
    ...
    monkeypatch.setattr("openagents_cli.main._require_tty", lambda *_a, **_kw: None)
