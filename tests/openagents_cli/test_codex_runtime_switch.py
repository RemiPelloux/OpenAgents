...
class TestApply:
    ...
    def test_enable_succeeds_when_codex_present(self):
        ...
        # Path.home() / ".codex" using whatever OPENAGENTS_HOME the running pytest
        ...
        with (
            ...
            patch("openagents_cli.codex_runtime_plugin_migration.migrate"),
        ):
    ...
    def test_enable_triggers_mcp_migration(self):
        """Enabling codex_app_server should auto-migrate OpenAgents mcp_servers
        ...
        with (
            patch.object(crs, "check_codex_binary_ok", return_value=(True, "0.130.0")),
            patch("openagents_cli.codex_runtime_plugin_migration.migrate") as mig,
        ):
        ...
        # OpenAgents tool callback announcement
    ...
    def test_disable_does_not_trigger_migration(self):
        ...
        with patch("openagents_cli.codex_runtime_plugin_migration.migrate") as mig:
            r = crs.apply(cfg, "auto")
        assert r.success
    ...
    def test_migration_failure_does_not_block_enable(self):
        ...
        with (
            patch.object(crs, "check_codex_binary_ok", return_value=(True, "0.130.0")),
            patch(
                "openagents_cli.codex_runtime_plugin_migration.migrate",
