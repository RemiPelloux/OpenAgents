...
from openagents_cli.main import _cmd_update_check, cmd_update
...
def test_cmd_update_in_docker_prints_guidance_and_exits(
    ...
    assert "docker pull nousresearch/openagents:latest" in out
...
def test_format_docker_update_message_contents():
    ...
    assert "docker pull nousresearch/openagents:latest" in msg
    ...
    assert "OPENAGENTS_HOME" in msg or "/opt/data" in msg, (
