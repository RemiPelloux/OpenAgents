...
class TestSubcommandCompletion:
    ...
    def test_tools_enable_completes_toolset_names(self, monkeypatch):
        ...
        from openagents_cli import commands as commands_mod
        ...
        monkeypatch.setattr("openagents_cli.config.load_config", lambda: {})
        monkeypatch.setattr(
            "openagents_cli.tools_config._get_plugin_toolset_keys",
            lambda: set(),
        )
...
from openagents_cli.commands import discord_skill_commands_by_category  # noqa: E402
...
class TestPluginCommandEnumeration:
    ...
    def _patch_plugin_commands(self, monkeypatch, commands):
        """Monkeypatch openagents_cli.plugins.get_plugin_commands() to a fixed dict."""
        from openagents_cli import plugins as _plugins_mod
