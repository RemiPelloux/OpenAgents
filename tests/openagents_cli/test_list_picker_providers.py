...
def test_openrouter_models_replaced_with_live_catalog(monkeypatch):
    ...
    monkeypatch.setattr(
        "openagents_cli.models.fetch_openrouter_models", lambda *a, **kw: list(live)
    )
...
def test_openrouter_falls_back_to_base_models_on_fetch_failure(monkeypatch):
    ...
    monkeypatch.setattr("openagents_cli.models.fetch_openrouter_models", _raise)
...
def test_openrouter_empty_live_catalog_drops_row(monkeypatch):
    ...
    monkeypatch.setattr(
        "openagents_cli.models.fetch_openrouter_models", lambda *a, **kw: []
    )
...
def test_include_moa_adds_virtual_provider_with_named_presets(monkeypatch):
    ...
    monkeypatch.setattr("openagents_cli.config.load_config", lambda: moa_config)
    monkeypatch.setattr(
        "openagents_cli.models.fetch_openrouter_models",
        lambda *a, **kw: pytest.fail("should not be called"),
    )
