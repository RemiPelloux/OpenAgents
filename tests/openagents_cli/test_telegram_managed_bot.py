"""Tests for openagents_cli.telegram_managed_bot — QR codes, deep links, pairing."""
...
class TestCreatePairing:
    def test_success(self):
        ...
        with patch(
            "openagents_cli.telegram_managed_bot.httpx.post", return_value=mock_resp
        ) as post:
            pairing = create_pairing("https://api.example.com", bot_name="OpenAgents")
...
class TestSetupTelegramAuto:
    def test_setup_helper_exists(self):
        from openagents_cli.setup import _setup_telegram_auto
    ...
    def test_setup_result_passes_profile_name_for_profile_home(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(setup, "get_openagents_home", lambda: profile_home)
        ...
        monkeypatch.setattr(
            "openagents_cli.telegram_managed_bot.auto_setup_telegram_bot_result",
    ...
    def test_profile_name_from_home_path_handles_windows_separators(self):
        from openagents_cli.setup import _profile_name_from_hermes_home
