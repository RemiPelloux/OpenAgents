"""Tests for _setup_feishu() in openagents_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("openagents_cli.config.save_env_value", side_effect=mock_save), \
         patch("openagents_cli.config.get_env_value", side_effect=mock_get), \
         patch("openagents_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("openagents_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("openagents_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("openagents_cli.cli_output.print_header"), \
         patch("openagents_cli.cli_output.print_info"), \
         patch("openagents_cli.cli_output.print_success"), \
         patch("openagents_cli.cli_output.print_warning"), \
         patch("openagents_cli.cli_output.print_error"), \
