...
def _run_setup_feishu(
    *,
    ...
    with (
        patch("openagents_cli.config.save_env_value", side_effect=mock_save),
        patch("openagents_cli.config.get_env_value", side_effect=mock_get),
        patch(
            "openagents_cli.cli_output.prompt_yes_no",
            side_effect=prompt_yes_no_responses,
        ),
        patch(
            "openagents_cli.setup.prompt_choice", side_effect=prompt_choice_responses
        ),
