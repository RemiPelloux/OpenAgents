...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.openagents/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at openagents_state import time, before pytest's OPENAGENTS_HOME monkeypatch
    fires — the autouse fixture's OPENAGENTS_HOME override doesn't help here.)
    """
