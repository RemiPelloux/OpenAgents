...
# worktree), ``MAIN_DIR`` falls back to a sibling ``openagents-main``
...
def _resolve_main_dir() -> Path:
    ...
    if (
        ...
        return candidate
    sibling = REPO_ROOT.parent / "openagents-main"
...
# Isolated OPENAGENTS_HOME so the config write is hermetic.
...
def main() -> int:
    ...
    if MAIN_DIR == PR_DIR:
        print(
            ...
            "      Set up a sibling 'openagents-main' checkout pinned to "
