...
from openagents_cli.nous_account import NousPortalAccountInfo, NousPaidServiceAccessInfo
...
def test_credits_command_registered():
    from openagents_cli.commands import resolve_command, COMMAND_REGISTRY
