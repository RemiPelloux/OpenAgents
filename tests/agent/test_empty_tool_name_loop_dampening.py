...
@pytest.fixture()
def agent_env():
    """Spin up the mock provider + an isolated OPENAGENTS_HOME, yield (agent, helpers)."""
    ...
    prev_home = os.environ.get("OPENAGENTS_HOME")
    os.environ["OPENAGENTS_HOME"] = os.path.join(test_home, ".hermes")
    ...
    try:
        ...
        if prev_home is None:
            ...
            os.environ["OPENAGENTS_HOME"] = prev_home
