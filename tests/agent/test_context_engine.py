...
class TestPluginContextEngineSlot:
    ...
    def test_register_engine(self):
        from openagents_cli.plugins import PluginManager, PluginContext, PluginManifest
    ...
    def test_get_plugin_context_engine(self):
        from openagents_cli.plugins import PluginManager, get_plugin_context_engine
