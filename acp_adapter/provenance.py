...
This is an additive OpenAgents extension surfaced under ACP ``_meta.hermes`` so
...
compression rotates the internal OpenAgents head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_hermes_session_id: The live internal OpenAgents DB session id
    ...
    Returns:
        A dict suitable for ``{"openagents": {"sessionProvenance": <dict>}}`` under
...
def session_provenance_meta(
    ...
    *,
    ...
    """Return a ready ``_meta`` payload: ``{"openagents": {"sessionProvenance": ...}}``."""
    ...
    if prov is None:
        return None
    return {"openagents": {"sessionProvenance": prov}}
