...
When the user runs OpenAgents inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), OpenAgents shifts into a **coding posture**. This module is the
...
_EDIT_FORMAT_GUIDANCE: dict[str, tuple[tuple[str, ...], str]] = {
    ...
    "replace": (
        ("claude", "sonnet", "opus", "haiku",
         ...
         "openagents", "llama", "mistral", "devstral", "minimax"),
        "- Edit format: author new files with `write_file`; for edits to "
...
def is_coding_context(
    *,
    ...
    """Whether OpenAgents should operate in its coding posture right now."""
