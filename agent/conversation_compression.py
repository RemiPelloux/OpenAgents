    ...
    try:
        ...
        if aux_context and aux_context < MINIMUM_CONTEXT_LENGTH:
            raise ValueError(
                ...
                f"minimum {MINIMUM_CONTEXT_LENGTH:,} required by OpenAgents "
...
def compress_context(
    ...
    *,
    ...
    # long-lived ``openagents_state.SessionDB`` class still bound to the
    ...
    if agent._session_db:
        try:
            ...
            if in_place:
                ...
                # from ``openagents_logging._session_context`` (set once per turn in
                ...
                try:
                    from openagents_cli.goals import migrate_goal_to_session
