...
Plugins built on OpenAgents often need to make their own LLM calls
...
:class:`~openagents_cli.plugins.PluginContext`:
...
class PluginLlm:
    ...
    Instances are constructed by :class:`openagents_cli.plugins.PluginContext`
