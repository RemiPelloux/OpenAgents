#!/usr/bin/env python3
"""Build the OpenAgents Model Catalog — a centralized JSON manifest of curated models.
...
OpenAgents CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a OpenAgents release.
...
# Ensure OPENAGENTS_HOME is set for imports that touch it at module level.
os.environ.setdefault("OPENAGENTS_HOME", os.path.join(os.path.expanduser("~"), ".hermes"))

from openagents_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "openagents repo",
            "docs": "https://openagents.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
