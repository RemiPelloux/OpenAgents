...
class HermesCLI(CLIAgentSetupMixin, CLICommandsMixin):
    ...
    def _show_gateway_status(self):
        ...
        try:
            ...
            print(f"    2. Or configure settings in {display_openagents_home()}/config.yaml")
            print()
...
def _run_kanban_goal_loop_q(cli: "HermesCLI", first_response: str) -> None:
    ...
    from openagents_cli.goals import run_kanban_goal_loop as _run_loop, DEFAULT_MAX_TURNS as _DEF_TURNS
