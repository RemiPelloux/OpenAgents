...
goal satisfied by the assistant's last response?". If not, OpenAgents feeds a
...
def _get_session_db() -> Optional[Any]:
    """Return a SessionDB instance for the current OPENAGENTS_HOME.
        ...
        if state.consecutive_parse_failures >= DEFAULT_MAX_CONSECUTIVE_PARSE_FAILURES:
            ...
            return {
                ...
                "message": (
                    ...
                    "model in ~/.openagents/config.yaml:\n"
                    "  auxiliary:\n"
                    "    goal_judge:\n"
                    "      provider: openrouter\n"
