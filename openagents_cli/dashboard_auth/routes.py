...
from openagents_cli.dashboard_auth.base import (
    InvalidCodeError,
...
def _redirect_uri(request: Request) -> str:
    ...
    from openagents_cli.dashboard_auth.prefix import (
        prefix_from_request,
        resolve_public_url,
    )
...
async def api_auth_ws_ticket(request: Request):
    ...
    from openagents_cli.dashboard_auth.ws_tickets import TTL_SECONDS, mint_ticket
