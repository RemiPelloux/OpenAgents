...
Design notes
------------
- Mirrors the shape of ``openagents_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the OpenAgents kanban board.
...
Rules:
  ...
  - Never write "OpenAgents profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_openagents_home())
        else:
