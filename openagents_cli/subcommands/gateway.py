...
Extracted verbatim from ``openagents_cli/main.py:main()`` (god-file Phase 2).
    ...
    *,
    ...
    gateway_migrate_legacy = gateway_subparsers.add_parser(
        ...
        description=(
            ...
            "units (openagents-gateway-<profile>.service) and unrelated "
    ...
    gateway_enroll = gateway_subparsers.add_parser(
        ...
        description=(
            ...
            "GATEWAY_RELAY_SECRET / GATEWAY_RELAY_DELIVERY_KEY into ~/.openagents/.env. "
    ...
    gateway_enroll.add_argument(
        ...
        help=(
            ...
            "GATEWAY_RELAY_WAKE_URL in ~/.openagents/.env and forwarded at provision. "
