...
def build_backup_parser(subparsers, *, cmd_backup: Callable) -> None:
    ...
    backup_parser = subparsers.add_parser(
        "backup",
        help="Back up OpenAgents home directory to a zip file",
        description="Create a zip archive of your entire OpenAgents configuration, "
        "skills, sessions, and data (excludes the openagents codebase). "
