...
def _config_base_url_trustworthy_for_bare_custom(
    ...
    try:
        from openagents_cli.auth import resolve_provider as _resolve_provider
...
def _copilot_runtime_api_mode(model_cfg: Dict[str, Any], api_key: str) -> str:
    ...
    try:
        from openagents_cli.models import copilot_model_api_mode
    ...
    *,
    ...
    if provider == "openai-codex":
        ...
        if effective_model and api_mode != "anthropic_messages":
            try:
                from openagents_cli.models import azure_foundry_model_api_mode
        ...
        if provider in {"opencode-zen", "opencode-go"}:
            ...
            # Refs #16878.
            from openagents_cli.models import opencode_model_api_mode
...
def _get_named_custom_provider(requested_provider: str) -> Optional[Dict[str, Any]]:
    ...
    if requested_norm != "custom" and not requested_norm.startswith("custom:"):
        try:
            ...
            # the built-in. See tests/openagents_cli/test_runtime_provider_resolution.py
    ...
    *,
    ...
    if not api_key:
        raise AuthError(
            ...
            "~/.openagents/.env or run 'hermes model' to configure. To use "
    ...
    *,
    ...
    if provider == "minimax-oauth":
        ...
        if pconfig and pconfig.auth_type == "oauth_minimax":
            from openagents_cli.auth import resolve_minimax_oauth_runtime_credentials
