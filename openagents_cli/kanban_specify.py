...
* This module intentionally mirrors ``openagents_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the OpenAgents board.
...
def _profile_author() -> str:
    """Mirror of ``openagents_cli.kanban._profile_author``. Kept local to
