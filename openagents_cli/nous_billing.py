...
billing screens drive. Companion to ``openagents_cli/nous_account.py`` (which owns
...
- **Auth** = the OAuth bearer JWT OpenAgents already holds for inference
...
# openagents_cli.auth.NOUS_BILLING_MANAGE_SCOPE (kept here too so this module has no
