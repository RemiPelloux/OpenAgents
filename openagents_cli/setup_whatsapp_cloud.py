...
``cmd_whatsapp_cloud`` in ``openagents_cli/main.py``).
...
OpenAgents gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures OpenAgents to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  OpenAgents needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the OpenAgents gateway in another terminal:")
    ...
    print()
    print("  Docs: https://openagents.nousresearch.com/docs/user-guide/")
