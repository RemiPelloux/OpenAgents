    ...
    for config_path in configs:
        try:
            ...
            for line in content.split("\n"):
                ...
                if "openagents" in line.lower() and (
...
def run_gui_uninstall(args):
    ...
    print(
        color(
            "│         ⚕ OpenAgents Chat GUI Uninstaller                  │",
            Colors.MAGENTA,
            Colors.BOLD,
        )
    )
    ...
    print(
        color(
            "This removes the Chat GUI only. The OpenAgents stays installed.",
            Colors.CYAN,
        )
    )
    print()
...
def run_uninstall(args):
    ...
    if full_uninstall:
        print(
            color(
                "⚠️  WARNING: This will permanently delete ALL OpenAgents data!",
                Colors.RED,
                Colors.BOLD,
            )
        )
        ...
        print(
            "This will remove the OpenAgents code but keep your configuration and data."
        )
