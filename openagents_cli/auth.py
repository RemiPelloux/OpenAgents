...
SPOTIFY_DOCS_URL = (
    "https://openagents.nousresearch.com/docs/user-guide/features/spotify"
)
...
OAUTH_OVER_SSH_DOCS_URL = (
    "https://openagents.nousresearch.com/docs/guides/oauth-over-ssh"
)
...
def _resolve_api_key_provider_secret(
    ...
    if provider_id == "copilot":
        ...
        try:
            from openagents_cli.copilot_auth import (
