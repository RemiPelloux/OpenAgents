"""
Single source of truth for provider identity in OpenAgents.
...
# -- OpenAgents overlay ----------------------------------------------------------
# OpenAgents-specific metadata that models.dev doesn't provide.
...
class ProviderDef:
    ...
    doc: str = ""
    source: str = ""                      # "models.dev", "openagents", "user-config"
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    Resolution order:
      1. OpenAgents overlays (for providers not in models.dev: nous, openai-codex, etc.)
      2. models.dev catalog + OpenAgents overlay
    ...
    if overlay is not None:
        # OpenAgents-only provider (not in models.dev)
        return ProviderDef(
            id=canonical,
