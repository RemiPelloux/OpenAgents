...
convention. State lives in the per-profile ``$OPENAGENTS_HOME/projects.db`` store
(see :mod:`openagents_cli.projects_db`).
...
def build_parser(
    ...
    p_create.add_argument("name", help="Human name, e.g. 'OpenAgents'")
