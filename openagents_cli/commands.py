...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef(
        "snapshot",
        "Create or restore state snapshots of OpenAgents config/state",
        "Session",
        cli_only=True,
        aliases=("snap",),
    ...
    CommandDef(
        "goal",
        "Set a standing goal OpenAgents works on across turns until achieved",
        "Session",
    ...
    CommandDef(
        "busy",
        "Control what Enter does while OpenAgents is working",
        "Configuration",
        cli_only=True,
    ...
    CommandDef(
        "company",
        "Scaffold a multi-agent company folder (roles, subagents, skills)",
        "Tools & Skills",
        aliases=("co",),
    ...
    CommandDef(
        "openagentconfig",
        "Run or manage saved OpenAgentUI workflows",
        "Tools & Skills",
        aliases=("oac",),
    ...
    CommandDef(
        "reload-skills",
        "Re-scan ~/.openagents/skills/ for newly installed or removed skills",
        "Tools & Skills",
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append((
        "openagents",
        "Talk to OpenAgents or run a subcommand",
        "[subcommand] [args]",
    ))
    seen.add("openagents")
...
def slack_app_manifest(
    request_url: str = "https://openagents.local/slack/commands",
) -> dict[str, Any]:
